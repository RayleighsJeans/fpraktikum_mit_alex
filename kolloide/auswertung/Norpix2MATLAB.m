...
%
% 640 x 480 = 1048576 bytes for the 8 bit sequence:
% or
% 640 x 480 x 2 = 2097152 bytes for the 12 bit sequence:
%
...
% 1024 + (1048576 + timestampBytes + 506) for the 8 bit
% or
% 1024 + (2097152 + timestampBytes + 506) for the 12 bit
